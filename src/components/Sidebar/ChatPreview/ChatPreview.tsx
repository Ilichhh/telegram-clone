...
function ChatPreview({
  ...
  const lastSeen = isSearchMode && !isOnlineStatus && data.userInfo?.lastVisitAt ? useTimestamp(data.userInfo?.lastVisitAt) : '';
  const lastMessageTime = !isSearchMode ? useTimestamp(data?.lastMessage?.date) : '';
